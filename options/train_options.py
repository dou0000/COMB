...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument(
            '--style_only',
            action='store_true',
            help='if specified, only train the style encoder',
        )
        ...
        parser.add_argument(
            ...
            type=str,
            default='default',
            help='name of the experiment. It is used in the folder name to store models and logs',
        )
        ...
        parser.add_argument(
            ...
            type=util.str2bool,
            default=False,
            help='if specified, use IR_5 dataset',
        )
        ...
        parser.add_argument(
            ...
            type=str,
            default='batch',
            help='normalization layer to use (batch|instance)',
        )
        ...
        parser.add_argument(
            ...
            type=int,
            default=0,
            help='which fold to use for held-out validation',
        )
